...
if __name__ == '__main__':
    ...
    controller.setUp()
    controller.test_login_logout()
    
    controller.setUp()
    controller.test_create_search_patient()
    
    controller.setUp()
    controller.test_retrieve_patients()
 
    controller.setUp()
    controller. test_update_patient()
    
    controller.setUp()
    controller. test_delete_patient()
    
    controller.setUp()
    controller.test_list_patients()

    controller.setUp()
    controller.test_set_get_current_patient

    controller.setUp()
    controller.test_create_search_note
    
    controller.setUp()
    controller.test_retrieve_notes()
    
    controller.setUp()
    controller.test_update_note()
    
    controller.setUp()
    controller.test_delete_note()
    
    controller.setUp()
    controller.test_list_notes()
